...
internal static partial class Il2CppInteropManager
{
    ...
    private static readonly ManualLogSource _Logger = Logger.CreateLogSource("InteropManager");
    ...
    private static bool CheckIfGenerationRequired()
    {
        ...
        {
            _Logger.LogInfo("Detected outdated interop assemblies, will regenerate them now");
            return true;
        }
    ...
    private static void GenerateInteropAssemblies()
    {
        ...
        {
            _Logger.LogError($"Failed to generate Il2Cpp interop assemblies: {e}");
        }
    }
    ...
    private static void DownloadUnityAssemblies()
    {
        ...
        _Logger.LogMessage("Downloading unity base libraries");
        ...
        _Logger.LogMessage("Extracting downloaded unity base libraries");
    ...
    private static List<AssemblyDefinition> RunCpp2Il()
    {
        ...
        stopwatch.Stop();
        _Logger.LogInfo($"Cpp2IL finished in {stopwatch.Elapsed}");
